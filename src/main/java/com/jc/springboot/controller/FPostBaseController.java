...
//    @RequiresPermissions("guide:list")
    ...
    //帖子表逻辑下架
    @RequestMapping("/updateIsLowerShelfD.do")
    ...
    //帖子表逻辑置顶
    @RequestMapping("/updateTopIsDel0.do")
    ...
    //帖子表逻辑取消置顶
    @RequestMapping("/updateTopIsDel1.do")
    ...
    @RequestMapping("/getListNavName.do")
    ...
    @RequestMapping("/updateBaseLabelIsDel1.do")
    ...
    @RequestMapping("/deleteBaseLabelF.do")
    ...
    @RequestMapping("/insertBaseLabelF.do")
    ...
    @RequestMapping("/listNavigationTop.do")
